          ...
          <div className="max-w-4xl mx-auto relative">
            ...
            <div className="space-y-8">
              {[
                ...
                >
                  {/* Timeline Dot */}
                  <div className="relative z-10 w-16 h-16 bg-white rounded-full flex items-center justify-center shadow-lg group-hover:scale-110 transition-all duration-300 cursor-pointer timeline-dot">
